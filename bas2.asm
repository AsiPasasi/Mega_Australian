...
; General Variables and files used for printing 
	ground dw 40320
	ground1 dw 300 dup (40320)
	ground2 dw 300 dup (40320)
	ground3 dw 300 dup (40320)
	ceiling dw 0
	ceiling1 dw 300 dup (0)
	ceiling2 dw 300 dup (0)
	ceiling3 dw 300 dup (0)
	x dw 5
	y dw 56000
	VerVel dw 0
	JCheck db 0
...
proc LoadMap
	;Loads the map for the level gets map through dx
	push ax
	push bx
	push cx
	push dx
	...
	mov ah,3fh
	mov cx, 600
	mov dx, offset ground1
	int 21h
	mov ah,3fh
	mov cx, 600
	mov dx, offset ground2
	int 21h
	mov ah,3fh
	mov cx, 600
	mov dx, offset ground3
	int 21h
	mov ah,3fh
	mov cx, 600
	mov dx, offset ceiling1
	int 21h
	mov ah,3fh
	mov cx, 600
	mov dx, offset ceiling2
	int 21h
	mov ah,3fh
	mov cx, 600
	mov dx, offset ceiling3
	int 21h
	call CloseFile
	pop dx
	pop cx
...
Tick95:
	...
	je Skip95IntelPrint
		cmp [DisBlockX], 259
		jnl SkipSkip95IntelPrint
			inc [RoomTimer4]
			cmp [RoomTimer4], 10
			je SkipSkip95IntelPrint
			jmp Skip95IntelPrint
		SkipSkip95IntelPrint:
			mov [RoomTimer4], 0
			mov dx, offset Intel
			mov [x], 240
			mov [y], 29440
